          ...
          <div className="container items-center mx-auto grid md:grid-cols-3 gap-5 mt-9 md:mt-20">
             <div class="max-w-sm rounded border border-blue-500 overflow-hidden shadow-lg mx-auto">
                  <div className="w-full p-8 text-center">
                     <div className=" ">
                        <h1 className="text-center mt-1 text-3xl font-bold">FREE</h1>  
                        <p className="text-center mt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed, explicabo fugiat?</p>
                        <h1 className="text-center mt-3 p-5 text-blue-400 text-4xl font-extrabold">0$ <span className="mt-1  text-blue-400 text-2xl">per month</span></h1>  
                     </div>
                  </div>
                  ...
                  <button className="w-full bg-blue-400 text-white text-center font-bold  mx-auto p-4">Try for free</button>
             </div> 

             <div class="max-w-sm rounded border bg-[#272742] overflow-hidden shadow-lg mx-auto">
                  <div className="w-full p-8 text-center">
                     <div className="text-white ">
                        <h1 className="text-center mt-1 font-bold text-3xl ">STANDARD</h1>  
                        <p className="text-center mt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed, explicabo fugiat?</p>
             ...
             <div class="max-w-sm rounded border border-blue-500 overflow-hidden shadow-lg mx-auto">
                  <div className="w-full p-8 text-center">
                     <div className=" ">
                        <h1 className="text-center mt-1 text-3xl font-bold ">PREMIUM</h1>  
                        <p className="text-center mt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed, explicabo fugiat?</p>
                        <h1 className="text-center mt-3 p-5 text-blue-400 text-4xl font-extrabold">9.99$ <span className="mt-1  text-blue-400 text-2xl">per month</span></h1>  
                     </div>
                  </div>
