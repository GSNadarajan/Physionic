...
const Getintouch = () =>{
    return(
    <div className=" bg-[#272742] mx-auto">
        <div className="container mt-4 md:mt-11 mb-11 md:flex p-8 mx-auto ">
            ...
            <div  className="w-full md:w-1/2 md:float-left md:right-100 mx-auto">
                <h1 className="text-white text-3xl font-bold ">Get Inm Touch</h1>
                <p className="text-white">Eos rem ducimus magni natus  repellat placeat?</p>
                <p className="text-white">Eos rem ducimus magninm</p>
            </div>

            <div className="className w-full md:w-1/2 mx-auto">  
